    ...
    create  table
      "company_dummy_entity"."main"."sale__dbt_tmp"
...
from "company_dummy_entity"."main"."prep_order_item" oi
inner join "company_dummy_entity"."main"."prep_order" o on oi.order_id = o.order_id
    );
