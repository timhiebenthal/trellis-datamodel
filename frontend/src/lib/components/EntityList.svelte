			...
			{#each sortedDomainGroups as [domain, domainEntities]}
				<div class="mb-4">
					...
					<button
						...
						class="w-full bg-gradient-to-r from-slate-50 to-slate-100 border-b border-slate-300 px-4 py-3 flex items-center gap-2 hover:from-slate-100 hover:to-slate-200 transition-all group"
					>
						<!-- Collapse Chevron -->
						...
						<!-- Domain Name -->
						<span
							class="text-base font-bold tracking-wide uppercase"
