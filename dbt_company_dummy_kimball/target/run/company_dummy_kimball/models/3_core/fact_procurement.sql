    ...
    create  table
      "company_dummy_kimball"."main"."fact_procurement__dbt_tmp"
...
from "company_dummy_kimball"."main"."prep_purchase_order_item" poi
inner join "company_dummy_kimball"."main"."prep_purchase_order" po on poi.purchase_order_id = po.purchase_order_id
    );
